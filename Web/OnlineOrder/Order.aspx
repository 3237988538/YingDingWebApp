<%@ Page Title="" Language="C#" MasterPageFile="~/Web/shared/Frontend.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="YingDingWebApp.Web.OnlineOrder.Order1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="bennera">
		<div class="benner_1a">
			<div class="benner_2a">
				<img src="../assets/images1/tu37.jpg" /></div>
		</div>
	</div>
	...
	<div class="xia">
		...
		<div class="jieshu">
			<img src="../assets/images1/tu18.jpg" /></div>
		...
		<div class="jieshu_1">
			<div class="dan">
				<div class="dan_1">
					...
					<div class="dan_1_3">
						<img src="../assets/images1/tu16.jpg" /></div>
					...
					<div class="dan_2_2">
						<div class="dan_2_2a1">
							<div class="dan_2_2_11">
								<img src="../assets/images1/tu19.jpg" /></div>
						</div>
						<div class="dan_2_2_2">高考报考定位卡</div>
					</div>
				</div>
				<div class="dan_3">
					<div class="dan_1_1"><b>费用：</b></div>
					<div class="dan_1_3"><b>￥</b></div>
					<div class="dan_3_2"><b>398</b></div>
			...
			<div class="ye_1">
				<div class="ye_1_1"><a href="#">
					<img src="../assets/images1/tu4.png" /></a></div>
				<div class="ye_1_2">
					<div class="ye_1_2_1">
					...
					<div class="ye_2"><a href="#">
						<img src="../assets/images1/tu15.jpg" /></a></div>
				</div>
			</div>
			<div class="kuai">
				<div class="kuai_1">
					<img src="../assets/images1/tu8.png" /></div>
				<div class="kuai_2">
					<div class="kuai_2_1">
