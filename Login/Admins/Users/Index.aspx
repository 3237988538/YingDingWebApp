<%@ Page Title="" Language="C#" MasterPageFile="~/Login/Admins/shared/_Backend.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="YingDingWebApp.Login.Admins.Users.Index" %>
                    ...
                    <div class="profile-left">
                        ...
                        <div class="profile-header">
                            ...
                            <div class="profile-main">
                                ...
                                <h3 class="name"><%#Eval("User_NickName") %></h3>
                        ...
                        <div class="profile-detail">
                            <div class="profile-info">
                                ...
                                <ul class="list-unstyled list-justify">
                                    <li>Address <span><%#Eval("User_Address")%></span></li>
                                    <li>Mobile <span><%# Eval("User_Phone")%></span></li>
                                    <li>Email <span><%#Eval("User_Account")%></span></li>
